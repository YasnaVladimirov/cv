...
1. `docs/implementation-plan-portfolio-website.md` (v2.0) — what to build, in what order, and definition-of-done per phase. **Read its Changelog first.**
